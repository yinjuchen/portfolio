  ...
  return (
    <main className="case-study-page">
      ...
      <section className="case-study-section">
        ...
        <p>
          AI-Assisted Support Workflow Design is a case study focused on how AI
          can assist customer support without fully replacing human judgment.
        </p>

        <p>
          The goal of this project was to map a simple support workflow where AI
          helps draft replies for common customer questions, while human support
          review, escalation rules, and documentation updates remain part of the
          process.
        </p>

        <p>
          This project connects my customer support background with AI-assisted
          support operations, support quality, escalation thinking, and knowledge
          base improvement.
        </p>
      </section>
      ...
      <section className="case-study-section">
        ...
        <p>
          ...
          I wanted to show how AI could be used as a support assistant while
        ...
        <div className="goal-grid">
          <article>
            ...
            <p>
              AI can help draft responses for repeated or low-risk support
              questions.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Human support should review AI replies before they are sent to
              customers.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Billing, privacy, account access, and technical issues should
              follow clear escalation rules.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Repeated customer questions should become FAQ updates, macros, or
      ...
      <section className="case-study-section">
        ...
        <div className="workflow-map">
          ...
          <article>
            ...
            <p>AI drafts a possible response based on the issue type.</p>
          </article>
          ...
          <article>
            ...
            <p>Repeated questions become FAQ, macro, or help article updates.</p>
          </article>
        </div>
      </section>
      ...
      <section className="case-study-section">
        ...
        <div className="checkpoint-grid">
          ...
          <article>
            <h3>Tone Check</h3>
            <p>
              Does the message sound polite, calm, and appropriate for the
          ...
          <article>
            ...
            <p>
              Does the reply avoid unsupported claims, promises, or
          ...
          <article>
            <h3>Context Check</h3>
            <p>
              Does the reply recognize what the customer already tried or
              already explained?
            </p>
          </article>
          ...
          <article>
            <h3>Risk Check</h3>
            <p>
              Does the issue involve billing, privacy, account security, or
          ...
          <article>
            ...
            <p>
              Does the customer know what to do next after reading the response?
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="case-study-section">
        ...
        <div className="feedback-loop">
          ...
          <article>
            ...
            <p>
              Support tags the issue as a FAQ candidate, macro candidate, or
              product feedback.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              The team updates help center articles, reply macros, or internal
              notes.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Better documentation makes future human and AI-assisted replies
              clearer.
            </p>
          </article>
        </div>
